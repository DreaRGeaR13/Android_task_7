package kz.talipovsn.Json_BZH_Lab8;
...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "https://api.github.com/users/proffix4/followers"; // Адрес получения JSON - данных
        ...
        if (json != null) {
            ...
            try {
                ...
                for(int i = 0; i < 30; i++) {
                    ...
                    String login1 = url.getString("login");
                    textView.append(i+1+". " + login1 + " id: " + name + " ссылка на гитхаб" + " ( "+link +" ) " );
                    textView.append("\n");
                }
            } catch (Exception e) {
